        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Q&A게시판 - 글쓰기 </h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Q&A게시판 - 글쓰기</h4>
                    ...
                    <p name="id" class="card-description text-success">${ sessionScope.id }</p>
                      ...
                      <button type="button" class="btn btn-dark" onclick="location.href='./list.do';">목록으로 돌아가기</button>
                    </form>
                  </div>
                </div>
              </div>
